...
public class UploadAndFavTest extends BaseTest {
    private final String PATH_TO_IMAGE = "src/test/resources/logo.jpeg";
    ...
    void uploadFileJPEGTest() {
        ...
        given()
                ...
                .when()
                .post(Endpoints.FAVORITE_IMAGE, uploadedImageId)
                .prettyPeek()
                .then()
                .statusCode(200);
    }
