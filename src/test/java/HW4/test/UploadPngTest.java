...
public class UploadPngTest extends BaseTest {
    private final String PATH_TO_IMAGE = "src/test/resources/logo3.png";
    ...
    void beforeTest() {
        ...
        multiPartSpecWithFile = new MultiPartSpecBuilder(new File("src/test/resources/logo3.png"))
                .controlName("image")
                .build();
