...
public class SmallPictTest extends BaseTest {
    private final String PATH_TO_IMAGE = "src/test/resources/logo4.jpg";
...
//    String imageHash;
    ...
    void beforeTest() {
        ...
        multiPartSpecWithFile = new MultiPartSpecBuilder(new File("src/test/resources/logo4.jpg"))
                .controlName("image")
                .build();
